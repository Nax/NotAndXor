...
<Image src="smz3" alt="Screenshot of the title screen of SMZ3"/>
...
<div style="display: flex; gap: 10px; justify-content: center; align-items: center;">
  <Image src="title_oot" alt="Screenshot of the title screen of 'The Legend of Zelda: Ocarina of Time'"/>
  <Image src="title_mm" alt="Screenshot of the title screen of 'The Legend of Zelda: Majora's Mask'"/>
</div>
